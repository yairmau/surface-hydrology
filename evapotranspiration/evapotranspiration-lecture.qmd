...
![](/archive/figures/musy-figure5.1.png)

![](/archive/figures/trimble-figure4.1.png)
...
a) the albedo of the surface, which determines the net radiation;  
b) the maximum leaf conductance;  
c) the atmospheric conductance, largely determined by vegetation height; d) presence or absence of intercepted water.
...
![Source: @ward2003environmental](/archive/figures/trimble-table4.3.png)
...
![Source: @ward2003environmental](/archive/figures/trimble-figure4.13.png)

## Thornthwaite

Source: @ward2003environmental, pages 107-108.
...
![](/archive/figures/th-et.png)

## Penman

Sources:  
@brutsaert2005hydrology, pages 123-127.  
@ward2003environmental, subsections 4.5.2, 4.5.3, 4.5.5, 4.6.6.  
@allen1998crop, ["Crop evapotranspiration - Guidelines for computing crop water requirements - FAO Irrigation and drainage paper 56"](http://www.fao.org/3/x0490e/x0490e07.htm#chapter%203%20%20%20meteorological%20data)
...
### Net Radiation
Source: @ward2003environmental, page 99.
...
We can find below a table for $R_{so}$, from @ward2003environmental, page 100.
![](/archive/figures/trimble-table4.5.png)
...
Source: @ward2003environmental, page 95.
...
![Source: @ward2003environmental, page 96](/archive/figures/trimble-figure4.11.png)
...
![Source: @brutsaert2005hydrology, page 28](/archive/figures/brutsaert-fig2.1.png)

There are a few ways of defining the function for $\Delta(T)$ (kPa °C$^{-1}$). @ward2003environmental give the following:
...
Source: @ward2003environmental, page 108
...
![](/archive/figures/dingman-figure6.3.png)

### Crop Coefficient

![](/archive/figures/musy-figure5.9.png)
...
![](/archive/figures/trimble-table4.7.png)
