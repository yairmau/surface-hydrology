...
@daly2019linking,
@sposito2017understanding,
@jones2012ecosystem,
@krajewski2021attempt,
@berghuijs2020unanswered,
@creed2012budyko
...
@budyko1974climate, proposed the following equation:

$$
\frac{ET}{P} = \left[ D_I \tanh\left( \frac{1}{D_I} \right)\left( 1-e^{-D_I} \right) \right]^{1/2}
$$

![](/archive/figures/budyko2.png)

![Source: @jones2012ecosystem](/archive/figures/jones-creed-fig5b.png)

![Source: @krajewski2021attempt](/archive/figures/Krajewski-2021-fig1.png)
...
![Source:  @zhang2004rational](/archive/figures/zhang-2004-fig7.png)

## Hypotheses for why dryness index controls so much the partitioning of P into ET and Q

Source:  @berghuijs2020unanswered
